    ...
    <div class="col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="mt-5">
                    <a href="{{route('dashboard.contact.index')}}" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
    ...
    $(function(){
        ...
        $(document).on("click",".btn-delete",function(){
            if(confirm("Apakah anda yakin ingin menghapus data ini ?")){
                $("#frmDelete").attr("action", "{{ route('dashboard.contact.destroy', '_id_') }}".replace("_id_", '{{$result->id}}'));
                $("#frmDelete").submit();
            }
        })
    })
