...
@section("title_breadcumb","contact")
@section('breadcumb')
    contact
@endsection
@section("content")
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex mb-1">
                                                <a href="{{route('dashboard.contact.show',$row->id)}}" class="btn btn-success btn-sm mr-1"><i class="fa fa-address-card"></i> Detail</a>
...
@include("dashboard.pages.contact.modal.index")
    ...
    $(function(){
        ...
        $(document).on("click",".btn-delete",function(){
            ...
            if(confirm("Apakah anda yakin ingin menghapus data ini ?")){
                $("#frmDelete").attr("action", "{{ route('dashboard.contact.destroy', '_id_') }}".replace("_id_", id));
