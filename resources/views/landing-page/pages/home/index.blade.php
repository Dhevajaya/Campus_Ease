...
@section('content')
    <!--====== Start Hero Section ======-->
    <section class="hero-area hero-style-three bg_cover"
        style="background-image: url({{ URL::to('/') }}/templates/landing-page/assets/images/hero/bg.png);">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-content">
                        ...
                        <h2 class="text-white" data-aos="fade-up" data-aos-delay="80">Selamat datang di
                            {{ web_settings('web', 'website_name') }}</h2>
                        <p data-aos="fade-up" data-aos-delay="90">{{ web_settings('web', 'home_quotes') }}</p>
                        <a href="{{ route('landing-page.contact.index') }}" class="main-btn btn-gradient-yellow"
                            data-aos="fade-up" data-aos-delay="100">Hubungi Kami</a>
                    </div>
                </div>
                <div class="col-lg-5">
    ...
    <section class="features-area pb-30 pt-30">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="block-style-one block-icon-animate animated-hover-icon mb-40" data-aos="fade-up"
                        data-aos-delay="30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 d-flex flex-column align-self-center">
                                <!-- Gantikan gambar dengan video -->
                                <div class="embed-responsive embed-responsive-16by9 w-100 mb-3">
                                    <video class="embed-responsive-item" controls>
                                        <source src="{{ asset('templates/landing-page/assets/video/vd.mp4') }}" type="video/mp4">
                                        Browser Anda tidak mendukung tag video.
                                    </video>
                                </div>
                                <p class="text-center mt-2">{{ web_settings('web', 'principal_name') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
                        ...
                        <div class="block-style-one">
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <h3>{{ $row->title }}</h3>
                                    <p>{{ $row->fragment }}</p>
                                    <p class="mt-2"><small>Dipublikasi Pada:
                                            {{ date('d F Y H:i:s', strtotime($row->published_at)) }}</small></p>
                                    <a href="{{ route('landing-page.announcements.show', $row->slug) }}"
                                        class="btn btn-primary btn-sm mt-3">Baca Selengkapnya</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    <a href="{{ route('landing-page.announcements.index') }}" class="main-btn btn-blue-dark">Lihat Semua
                        Beasiswa</a>
                </div>
            </div>
        </div>
    ...
    <section class="features-area pb-90">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <a href="{{ route('landing-page.daftaruniversitas.index') }}" class="main-btn btn-blue-dark">Lihat
                        Semua Universitas</a>
                </div>
            </div>
        </div>
    ...
    <section class="team-area team-style-one pb-90">
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <a href="{{ route('landing-page.employees.index') }}" class="main-btn btn-blue-dark">Lihat Semua
                        Anggota</a>
                </div>
            </div>
        </div>
